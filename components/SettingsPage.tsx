        ...
        <div className="space-y-6 max-w-4xl mx-auto pb-12">
            ...
            <div className="flex justify-between items-center bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 transition-colors duration-200">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-slate-400">Configure your system preferences, localization, and privacy controls.</p>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 transition-colors duration-200">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 dark:text-slate-400 font-medium">Customize the visual theme of your student workspace.</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                        ...
                        <div>
                            <h4 className="font-bold text-sm text-gray-900 dark:text-white">Light Mode</h4>
                            <p className="text-xs text-gray-500 dark:text-slate-400 mt-1">Clean white layouts with elegant contrasting text.</p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 dark:text-slate-400 mt-1">Sleek dark themes friendly for low-light studying.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 transition-colors duration-200">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h3 className="font-bold text-gray-900 dark:text-white">Language & Region</h3>
                        <p className="text-xs text-gray-500 dark:text-slate-400 font-medium">Configure your locale, language display, and time zone.</p>
                    </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-2 font-medium">Display Language</label>
                        <select 
                            value={language}
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-2 font-medium">Time Zone</label>
                        <select 
                            value={timezone}
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 transition-colors duration-200">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 dark:text-slate-400 font-medium">Select what updates and alerts you wish to be notified about.</p>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 border border-gray-50 dark:border-slate-800 rounded-xl">
                        <div>
                            <h4 className="font-semibold text-sm text-gray-900 dark:text-white">Course Announcements</h4>
                            <p className="text-xs text-gray-500 dark:text-slate-400 mt-0.5">Receive alerts when instructors post updates or new learning modules.</p>
                        </div>
                        <button 
                    ...
                    <div className="flex items-center justify-between p-4 border border-gray-50 dark:border-slate-800 rounded-xl">
                        <div>
                            <h4 className="font-semibold text-sm text-gray-900 dark:text-white">Exam & Anti-Cheat Rules</h4>
                            <p className="text-xs text-gray-500 dark:text-slate-400 mt-0.5">Get reminded about strict deadlines, exam availability, or environment alerts.</p>
                        </div>
                        <button 
                    ...
                    <div className="flex items-center justify-between p-4 border border-gray-50 dark:border-slate-800 rounded-xl">
                        <div>
                            <h4 className="font-semibold text-sm text-gray-900 dark:text-white">Wallet & Transaction Alerts</h4>
                            <p className="text-xs text-gray-500 dark:text-slate-400 mt-0.5">Receive confirmations for wallet balance deposits, subscriptions, or credit card updates.</p>
                        </div>
                        <button 
                    ...
                    <div className="flex items-center justify-between p-4 border border-gray-50 dark:border-slate-800 rounded-xl">
                        <div>
                            <h4 className="font-semibold text-sm text-gray-900 dark:text-white">Newsletters & Job Postings</h4>
                            <p className="text-xs text-gray-500 dark:text-slate-400 mt-0.5">Stay updated with career guides, partner openings, and Welile School newsletters.</p>
                        </div>
                        <button 
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 transition-colors duration-200">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h3 className="font-bold text-gray-900 dark:text-white">Security & Privacy</h3>
                        <p className="text-xs text-gray-500 dark:text-slate-400 font-medium">Configure profile visibility and security authentications.</p>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 border border-gray-50 dark:border-slate-800 rounded-xl">
                        <div>
                            ...
                            <p className="text-xs text-gray-500 dark:text-slate-400 mt-0.5">Require an authentication code from your mobile app when signing in.</p>
                        </div>
                        <button 
                    ...
                    <div className="flex items-center justify-between p-4 border border-gray-50 dark:border-slate-800 rounded-xl">
                        <div>
                            <h4 className="font-semibold text-sm text-gray-900 dark:text-white">Public Profile Visibility</h4>
                            <p className="text-xs text-gray-500 dark:text-slate-400 mt-0.5">Allow partners and other students to see your career goal, wallet rank, and skill badges.</p>
                        </div>
                        <button 
